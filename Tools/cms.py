...
def DetectCMS(site):
    ...
    try:
        CheckWp = requests.get(Wordpress, timeout=2, headers=Headers).content
        if '/wp-content/' in str(CheckWp) or '/wp-inclues/' in str(CheckWp):
            try:
                ...
                pass
            return 'wordpress'
        CheckWp2 = requests.get(Wordpress2, timeout=2, headers=Headers).content
        if '(c) jQuery Foundation' in str(CheckWp2):
            try:
                ...
                pass
            return 'wordpress'
        CheckJom = requests.get(Joomla, timeout=2, headers=Headers).content
        if '"COMPONENTS_BANNERS_BANNERS"' in str(CheckJom):
            try:
                ...
                pass
            return 'joomla'
        CheckJom2 = requests.get(Joomla2, timeout=2, headers=Headers).content
        if '<author>Joomla!' in str(CheckJom2):
            try:
                ...
                pass
            return 'joomla'
        CheckJom3 = requests.get(Joomla3, timeout=2, headers=Headers).content
        if '<author>Joomla!' in str(CheckJom3):
            try:
                ...
                pass
            return 'joomla'
        CheckJom4 = requests.get(Joomla4, timeout=2, headers=Headers).content
        if 'content="Joomla!' in str(CheckJom4):
            try:
                ...
                pass
            return 'joomla'
        CheckDrupal = requests.get(drupal, timeout=2, headers=Headers).content
        if 'Drupal.ajax' in str(CheckDrupal):
            try:
                ...
                pass
            return 'drupal'
        CheckDrupal2 = requests.get(drupal2, timeout=2, headers=Headers).content
        if '/sites/default/files' in str(CheckDrupal2):
            try:
                ...
                pass
            return 'drupal'
        CheckOpencart = requests.get(Opencart, timeout=2, headers=Headers).content
        if 'getURLVar(key)' in str(CheckOpencart):
            try:
                ...
                pass
            return 'opencart'
        CheckOsCommerce = requests.get(osCommerce, timeout=2, headers=Headers).content
        if 'function SetFocus()' in str(CheckOsCommerce):
            try:
                ...
                pass
            return 'oscommerce'
        Checkvb = requests.get(vBulletin, timeout=2, headers=Headers).content
        if 'GIF89a' in str(Checkvb):
            try:
                ...
                pass
            return 'vBulletin'
        Checkvb2 = requests.get(vBulletin2, timeout=2, headers=Headers).content
