# coding=utf-8
# --------------------------------
YOUR_Email_For_TAkeAdmin_Exploit = 'izazelus@gmail.com'  # Edit this line with your email Address
r = '\033[31m'
g = '\033[32m'  # KingBoT Version 1.0 [31/12/2019]
...
VERSION = 'TrinityBot Version 1.0'
...
try:
    ...
    print('[-] bs4 Modulunu kurmaniz gerekiyor.')
    sys.exit()
...
try:
    ...
    print('[-] requests modulunu kurmaniz gerekiyor.')
    sys.exit()
